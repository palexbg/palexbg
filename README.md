...
- **LLM-based Fusion of Multi-modal Features for Commercial Memorability Prediction** (2025)
  - [Paper](https://arxiv.org/abs/2510.22829) accepted for publication at CEUR-WS | [Code](https://github.com/dsgt-arc/mediaeval-2025-memorability) (in progress) 
...
- **Multilingual Claim-Normalisation RAG** (2025)
  ...
  - Published om CEUR-WS for [CLEF CheckThat! 2025 (Task 2)](https://checkthat.gitlab.io/clef2025/task2/).
...
- **Quantum Annealing for Machine Learning Research** (2025)
  ...
  - Published in CEUR-WS for [QuantumCLEF 2025](https://qclef.dei.unipd.it/clef2025-lab) and presented at [CLEF 2025 conference](https://clef2025.clef-initiative.eu/).
